...
본 SRS 문서는 **"씨드핀 (Seedpin) - 예산 맞춤 투자 분석 플랫폼"** (구. 재개발 의사결정 Navigator) 시스템의 소프트웨어 요구사항을 정의한다. 본 문서의 목적은 다음과 같다:
...
| 1.2 | 2026-04-25 | Requirements Engineering Team | 브랜드 명칭 '씨드핀(Seedpin)' 확정. REQ-FUNC-014-3(기축 아파트 평형 타입 배지 표시), REQ-FUNC-019-1(Verified 매물 중개소 연결 기능) 추가 반영. UI 색상 테마(Tech Blue, Neon Mint) 도입. |
